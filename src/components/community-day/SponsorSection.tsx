...
export function SponsorSection() {
  ...
  return (
    <section id="sponsors" className="py-24 px-4 bg-slate-900 border-b border-white/5 relative overflow-hidden">
      {/* Dynamic Background Glows */}
      <div className="absolute left-0 bottom-1/4 w-[350px] h-[350px] bg-purple-500/5 dark:bg-purple-900/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute right-0 top-1/4 w-[300px] h-[300px] bg-orange-500/5 dark:bg-orange-950/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container max-w-6xl mx-auto space-y-16">
            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  isGold 
                    ? "bg-slate-950/80 border-amber-500/30 shadow-xl shadow-amber-500/5 ring-1 ring-amber-500/10 lg:scale-[1.03] z-10" 
              ...
              >
                ...
                {isGold && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 text-[10px] font-extrabold uppercase tracking-widest px-3 py-1 rounded-full shadow-lg">
                    ★ Featured Tier
                  </div>
                )}
        ...
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-purple-500/[0.04] via-slate-950/50 to-orange-500/[0.02] border border-purple-500/20 rounded-3xl p-8 sm:p-10 flex flex-col items-center text-center gap-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center items-center relative z-10">
            <Button 
              variant="outline" 
              className="bg-transparent border-white/15 hover:bg-white/5 text-white py-6 w-full sm:min-w-[200px] justify-center rounded-xl active:scale-95 transition-all text-sm font-medium"
              onClick={() => {
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              <DialogTrigger asChild>
                <Button className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-bold py-6 w-full sm:min-w-[200px] justify-center rounded-xl active:scale-95 transition-all text-sm">
                  <Handshake className="mr-2 h-4 w-4" /> Register Interest
                </Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[440px] bg-slate-950 border-white/10 text-white">
                ...
                {isSuccess ? (
                  <div className="py-8 text-center space-y-3 flex flex-col items-center animate-in fade-in duration-300">
                    ...
                    <h4 className="text-lg font-bold text-white">Interest Registered!</h4>
                    <p className="text-sm text-gray-400">Our Sponsorship lead will email you shortly.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-4 pt-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        id="name"
                        required
                        className="bg-slate-900 border-white/10 text-white focus-visible:ring-orange-500"
                        value={formData.name}
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="email" className="text-sm text-gray-300">Business Email</Label>
                      <Input
                        id="email"
                        type="email"
                        required
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="tier" className="text-sm text-gray-300">Preferred Tier</Label>
                      <select
                        id="tier"
                        className="w-full bg-slate-900 border border-white/10 rounded-md p-2.5 text-sm text-white focus:outline-none focus:ring-1 focus:ring-orange-500"
                        value={formData.tier}
